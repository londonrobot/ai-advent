...
// Max tokens limit for responses (per completion)
const parsedMax = parseInt(process.env.LLM_MAX_TOKENS, 10);
const LLM_MAX_TOKENS = Number.isFinite(parsedMax) && parsedMax > 0 ? parsedMax : 250;
